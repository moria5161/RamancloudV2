...
const STEP_TYPES = {
  cut: { icon: Scissors, label: 'Cut', color: 'from-emerald-500 to-teal-600' },
  denoise: { icon: Waves, label: 'Denoise', color: 'from-blue-500 to-cyan-600' },
  baseline: { icon: Baseline, label: 'Baseline', color: 'from-purple-500 to-pink-600' },
};
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Pipeline Steps</h3>
      ...
      <div className="space-y-2">
            ...
            <div key={step.id} className={`glass rounded-xl overflow-hidden border ${isExpanded ? 'border-indigo-500/30' : 'border-white/5'} transition-all duration-200`}>
              ...
              {isExpanded && (
                <div className="px-3 pb-3 pt-1 border-t border-white/5 bg-black/20 animate-fade-in">
                  {step.type === 'cut' && (
                    <div className="space-y-2">
                      <label className="text-xs text-gray-400">Wavenumber Range (cm⁻¹)</label>
                    ...
                    <div className="space-y-2">
                      ...
                      {step.method === 'sg' && (
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="text-[10px] text-gray-500">Window</label>
                      ...
                      {step.method === 'peer' && (
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="text-[10px] text-gray-500">Loops</label>
                          ...
                          <div>
                            <label className="text-[10px] text-gray-500">Peak Seek</label>
                      ...
                      {step.method === 'wtd' && (
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="text-[10px] text-gray-500">Wavelet</label>
                  ...
                  {step.type === 'baseline' && (
                    <div className="space-y-2">
                      ...
                      {step.method === 'airpls' && (
                        <div className="grid grid-cols-2 gap-2">
                          <div>
                            <label className="text-[10px] text-gray-500">Lambda</label>
                          ...
                          <div>
                            <label className="text-[10px] text-gray-500">Diff Order</label>
                      ...
                      {step.method === 'imodpoly' && (
                        <div>
                          <label className="text-[10px] text-gray-500">Poly Order</label>
        ...
        {steps.length === 0 && (
          <div className="text-center py-6 text-gray-600 text-sm">
            Add steps below to build your pipeline
          </div>
        )}
      </div>
