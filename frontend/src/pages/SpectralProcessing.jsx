      ...
      <div className="flex-1 flex flex-col min-w-0 relative">
        <div className="flex items-center justify-between px-5 py-3 border-b border-white/5 glass">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-sm font-semibold text-gray-200">Spectral Processing Workspace</h2>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              {viewMode === 'overlay' ? 'Compare View' : 'Overlay View'}
            </button>
            <button
          ...
          {!hasData ? (
            <div className="h-full flex items-center justify-center">
              <div className="text-center space-y-6 animate-fade-in">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-300">Load Spectral Data</h3>
                  <p className="text-sm text-gray-500 mt-1">Upload a .txt file or select a demo dataset</p>
                </div>
                <div className="flex gap-3 justify-center">
                  ...
                  <button onClick={() => loadDemo('bacteria')}
                    ...
                    <FileUp className="w-4 h-4" /> Bacteria Demo
                  </button>
                </div>
                {error && (
            ...
            <div className="h-full animate-fade-in">
              ...
              <div className="absolute bottom-16 left-8 flex gap-2">
                {processedData && <span className="px-2 py-1 text-[10px] rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">Processed</span>}
                {baselineData && <span className="px-2 py-1 text-[10px] rounded-full bg-purple-500/10 text-purple-400 border border-purple-500/20">Baseline Corrected</span>}
              </div>
            </div>
          )}
        </div>
